/**
 * Default seed content — real data from Nandhakumar's resume.
 * Mirrored on the client (client/src/data/defaultData.js) so the site still
 * renders fully if the API is unreachable.
 */
...
const profile = {
  ...
  // { title, company, years, description } — add internships/roles here.
  // The public Experience page shows an "open to opportunities" state until
...
module.exports = { projects, certifications, skills, achievements, blog_posts, profile };
